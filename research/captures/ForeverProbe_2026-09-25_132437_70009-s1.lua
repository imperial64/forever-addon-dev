...
["external"] = {
["untouched"] = true,
["tokenWrittenThisSession"] = "132314-9147",
["loads"] = 4,
["inbox"] = {
["default"] = {
{
...
["transcript"] = {
"transcript cleared",
"build 1.60.1 (70009) Sep 23 2026 toc 16001",
"execute  16/18 present",
"read     32/48 present",
"  missing read APIs: GetSpellCooldown, GetSpellCharges, IsUsableSpell, IsSpellInRange, GetSpellInfo, IsCurrentSpell, GetSpellPowerCost, UnitAura, UnitBuff, UnitDebuff, CombatLogGetCurrentE",
"secure   22/23 present",
"channel  26/31 present",
"C_AssistedCombat PRESENT isAvailable=false rotationSpells=0",
"  This client ships its own rotation assist. Recorded, not acted on.",
"SECRECY HasSecretRestrictions=true Auras=false Cooldowns=false ActionCooldown(1)=false UnitIdentity(\"player\")=false UnitHealthMax(\"player\")=false UnitPower(\"player\")=true UnitStats=false U",
"  combatLogRestricted    true",
"  addonRestrictionState  0",
"  addonRestrictionActive false",
"  addonMessagesRestricted true",
"  chatMessagingLockdown  false",
"BLOCKED / FORBIDDEN actions captured",
"  none this session",
"AUCTION HOUSE",
"  modern        12/12",
"  commodity     5/5",
...
"  restricted    7/7",
"  legacyAction  0/4",
"  API  modern C_AuctionHouse only - retail AH code largely ports",
"  stand at an auction house and run /fprobe ah for the live half",
"EXTERNAL  io=false os=false load=true addonMsg=true cvar=true",
"            json=true clipboard=true reloadUI=true",
"  outbound is SavedVariables on /reload; inbound is a generated .lua run as addon code",
"global dump: 5982 functions, 271 C_ namespaces",
"EXTERNAL inbound (ExternalData.lua, executed at load)",
"  shipped default only - the file loads and the channel works, but nothing has",
"  written to it yet. Run scripts/write-external-data.ps1, then /reload.",
"EXTERNAL outbound (SavedVariables flush)",
"  read-back failed - this DB has seen 4 loads but no token survived",
"  loads recorded by this DB: 4",
"  wrote token 132314-9147 - it should reappear after /reload",
"action tests:",
"  CastSpellByName              allowed",
"  UseAction(slot1)             BLOCKED [ADDON_ACTION_FORBIDDEN:UseAction()]",
"  EditMacro                    allowed",
"  SetOverrideBindingClick      allowed",
"  SecureBtn:SetAttribute       allowed",
"  READ spellCooldownStart     nil",
"  READ playerPower            <SECRET>",
"  READ playerAura1            nil",
"  READ targetAura1            NO TARGET",
"  READ targetHealth           NO TARGET",
"  READ targetCasting          NO TARGET",
"  READ combatLogAPI           ABSENT",
"SECRECY HasSecretRestrictions=true Auras=false Cooldowns=false ActionCooldown(1)=false UnitIdentity(\"player\")=false UnitHealthMax(\"player\")=false UnitPower(\"player\")=true UnitStats=false U",
"  combatLogRestricted    true",
"  addonRestrictionState  0",
"  addonRestrictionActive false",
"  addonMessagesRestricted true",
"  chatMessagingLockdown  false",
"combat log: FORBIDDEN to register (measured). reader=false fired=0 readable=0 inCombat=0 subevents=0",
"BLOCKED / FORBIDDEN actions captured",
"  1. ADDON_ACTION_FORBIDDEN func=UseAction() during: UseAction(slot1)",
"recorded as 'outofcombat'",
"next: /fprobe ah at an auction house, /fprobe combat on a mob, then /reload.",
"COLD-START SEED  leg=cold  token=1790331848-1  at 2026-09-25 13:24:08",
"  companions: First 6/6, Late 6/6",
"  probe: ProbeDB ok, ProbeChar ok",
"  WRITE THE TOKEN DOWN. Next: no /reload - /quit, relaunch through Battle.net,",
"  same character, then /fprobe cold 1790331848-1",
},
["savedVars"] = {
["order"] = "unknown",
["phases"] = {
...
["tokenWrittenThisSession"] = "131514-2295",
},
["actions"] = {
["outofcombat"] = {
["tests"] = {
