...
| 3 | `spellID` | `SpellIdentifier` | yes |  |

**Returns**

| # | Name | Type | Nilable | Default |
|---|---|---|---|---|
| 1 | `newDuration` | `number` | yes |  |
...
Blizzard's own rendering: `C_UnitAuras.GetRefreshCarryOverDuration(auraInstanceUnit, auraInstanceID, optional spellID)`
