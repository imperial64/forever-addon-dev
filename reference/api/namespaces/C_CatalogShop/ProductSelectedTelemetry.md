...
| 2 | `sectionId` | `number` | no |  |
| 3 | `catalogShopProductID` | `number` | no |  |
| 4 | `wasCodeSelection` | `bool` | no |  |

**Returns**

_None._

Blizzard's own rendering: `C_CatalogShop.ProductSelectedTelemetry(categoryId, sectionId, catalogShopProductID, wasCodeSelection)`
