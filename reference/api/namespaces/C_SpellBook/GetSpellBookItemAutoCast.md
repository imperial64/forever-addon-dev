...
| # | Name | Type | Nilable | Default |
|---|---|---|---|---|
| 1 | `autoCastAllowed` | `bool` | no |  |
| 2 | `autoCastEnabled` | `bool` | no |  |
...
Blizzard's own rendering: `C_SpellBook.GetSpellBookItemAutoCast(spellBookItemSlotIndex, spellBookItemSpellBank)`
