...
|---|---|---|---|---|
| 1 | `unit` | `UnitToken` | no |  |
| 2 | `equipmentSlotIndex` | `luaIndex` | no |  |

**Returns**

| # | Name | Type | Nilable | Default |
|---|---|---|---|---|
| 1 | `azeritePowerIDs` | `table&lt;number&gt;` | no |  |

Blizzard's own rendering: `C_PaperDollInfo.GetInspectAzeriteItemEmpoweredChoices(unit, equipmentSlotIndex)`
