...
|---|---|---|---|---|
| 1 | `timerunningSeasonID` | `number` | no |  |
...
Blizzard's own rendering: `C_LiveEvent.OnLiveEventBannerClicked(timerunningSeasonID)`

System: `LiveEvent` · Namespace: `C_LiveEvent`
