...
|---|---|---|---|---|
| 1 | `relicItemID` | `number` | no |  |
| 2 | `relicSlotIndex` | `luaIndex` | no |  |
...
Blizzard's own rendering: `C_ArtifactUI.CanApplyRelicItemIDToEquippedArtifactSlot(relicItemID, relicSlotIndex)`
